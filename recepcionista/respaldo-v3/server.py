...
if(!pr){{let s=svc.toLowerCase();let c=city||'';if(s.includes('terapia'))pr=c.includes('Medellin')||c.includes('Medellín')?'Valentina Vaquero':'Laura Martínez';else if(s.includes('masaje'))pr='Valentina Vaquero';else if(s.includes('carbon'))pr=c.includes('Medellin')||c.includes('Medellín')?'Valentina Vaquero':'Laura Martínez';else if(s.includes('hidra'))pr=c.includes('Medellin')||c.includes('Medellín')?'Valentina Vaquero':'Laura Martínez';else if(s.includes('casmara'))pr='Valentina Vaquero';else if(s.includes('peeling'))pr='Dra. Julieth Arias';else if(s.includes('depilacion')||s.includes('depilación'))pr=c.includes('Medellin')||c.includes('Medellín')?'Valentina Vaquero':'Laura Martínez';else if(s.includes('micropigment'))pr=c.includes('Bogota')||c.includes('Bogotá')?'Dr. Jorge Cueter':'Dra. Julieth Arias';else if(s.includes('valoracion')||s.includes('valoración'))pr='Dr. Jorge Cueter';else if(s.includes('botox'))pr='Dr. Jorge Cueter';else if(s.includes('radiofrecuencia'))pr='Dr. Jorge Cueter';else if(s.includes('exosomas'))pr='Dr. Jorge Cueter';}}
...
async def twilio_whatsapp_webhook(request: Request):
    ...
    try:
        ...
        save_message(client["id"], body, "client")
        ...
        try:
            ...
            reply = ask_pepe(body, messages_for_ai)
...
async def evolution_whatsapp_webhook(request: Request):
    ...
    try:
        ...
        # Guardar mensaje del cliente
        save_message(client["id"], msg_text, "client")
        ...
        try:
            from main import ask_pepe, SYSTEM_PROMPT
            reply = ask_pepe(msg_text, messages_for_ai)
        except Exception as e:
            logger.error(f"Error IA: {e}")
            reply = None
